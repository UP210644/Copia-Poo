...
namespace ST.Application.helpers
{
    ...
    namespace ST.Application.Helpers
    {
        public class LdapService
        {
            ...
            public bool ValidateUser(string username, string password)
            {
                try
                {
                    var ldapPath = _configuration["ActiveDirectory:UPA"];
                    var adminUsername = _configuration["ActiveDirectory: UPA/Administrator"];
                    var adminPassword = _configuration["ActiveDirectory:Admin!"];
